...
export const cities: CityListItem[] = [
  ...
  { slug: "czestochowa", name: "Częstochowa", region: "Silesian · HQ" },
  ...
  { slug: "sosnowiec", name: "Sosnowiec", region: "Silesian" },
  { slug: "tychy", name: "Tychy", region: "Silesian" },
  { slug: "myslowice", name: "Mysłowice", region: "Silesian" },
  { slug: "rybnik", name: "Rybnik", region: "Silesian" },
  { slug: "zabrze", name: "Zabrze", region: "Silesian" },
  { slug: "bytom", name: "Bytom", region: "Silesian" },
  { slug: "ruda-slaska", name: "Ruda Śląska", region: "Silesian" },
  { slug: "dabrowa-gornicza", name: "Dąbrowa Górnicza", region: "Silesian" },
  { slug: "chorzow", name: "Chorzów", region: "Silesian" },
];
