...
export const projects: Project[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    heroAlt: "Sala bankietowa hotelu Van der Valk w Beveren po montażu akustycznego sufitu napinanego 50 mm — biały sufit, zasłony i parkiet w jodełkę.",
    ogImage: "/images/projects/van-der-valk-beveren/og.jpg",
    gallery: [
      { src: "/images/projects/van-der-valk-beveren/01-hall-overview.jpg", alt: "Sala bankietowa hotelu Van der Valk Beveren po montażu — biały akustyczny sufit napinany, zasłony i parkiet w jodełkę.", caption: "Sala bankietowa po realizacji", note: "Pogłos rozwiązany przy 50 mm głębokości systemu" },
      { src: "/images/projects/van-der-valk-beveren/02-perimeter.jpg", alt: "Styk sufitu napinanego z belką stropową i czarnymi słupami w sali bankietowej Van der Valk Beveren.", caption: "Wykończenie obwodowe", note: "Czysty styk przy belce i istniejących słupach" },
      { src: "/images/projects/van-der-valk-beveren/03-tech-hatches.jpg", alt: "Klapa techniczna wbudowana w akustyczny sufit napinany obok podświetlanej wyspy LED w sali Van der Valk Beveren.", caption: "Klapy techniczne", note: "Serwis instalacji bez demontażu folii" },
      { src: "/images/projects/van-der-valk-beveren/04-starry-sky.jpg", alt: "Gwiezdne niebo — punkty światłowodowe w suficie napinanym nad stolikami sali Van der Valk Beveren.", caption: "Gwiezdne niebo", note: "Punkty światłowodowe wbudowane w sufit" },
      { src: "/images/projects/van-der-valk-beveren/05-acoustic-layer.jpg", alt: "Czarna warstwa absorbera akustycznego odsłonięta podczas montażu, obok gotowej wyspy sufitu z podświetleniem LED.", caption: "Warstwa akustyczna", note: "Absorber za perforowaną folią — stąd aW 0,95" },
      { src: "/images/projects/van-der-valk-beveren/06-pole-detail.jpg", alt: "Wykończenie sufitu napinanego wokół czarnych ryflowanych słupów — detal z sali Van der Valk Beveren.", caption: "Wykończenie wokół słupa", note: "Bezszwowy styk z elementem konstrukcyjnym" },
    ],
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    heroAlt: "Antresola londyńskiej rezydencji-kaplicy — sklepiony sufit i ściany wykończone tkaniną Camira.",
    ogImage: "/images/projects/london-chapel-londyn/og.jpg",
    gallery: [
      { src: "/images/projects/london-chapel-londyn/01-vaulted-ceiling.jpg", alt: "Sklepiony sufit obity tkaniną Camira w londyńskiej rezydencji-kaplicy.", caption: "Sklepiony sufit w tkaninie", note: "Tkanina Camira na łukach sklepienia" },
      { src: "/images/projects/london-chapel-londyn/02-home-cinema.jpg", alt: "Domowe kino z napinanymi ścianami w tkaninie Camira — London Chapel.", caption: "Domowe kino", note: "Pełna kontrola akustyczna pomieszczenia" },
      { src: "/images/projects/london-chapel-londyn/03-stained-glass.jpg", alt: "Witraż kaplicy w otoczeniu napinanych ścian z tkaniny — London Chapel.", caption: "Witraż i tkanina", note: "Zabytkowy detal zachowany w nowej powłoce" },
      { src: "/images/projects/london-chapel-londyn/04-textile-detail.jpg", alt: "Detal faktury tkaniny Camira na napinanej ścianie przy schodach.", caption: "Detal tkaniny", note: "Camira — producent tekstyliów kontraktowych" },
      { src: "/images/projects/london-chapel-londyn/05-perimeter.jpg", alt: "Wykończenie obwodowe napinanej ściany tekstylnej wzdłuż biegu schodów.", caption: "Wykończenie obwodowe", note: "Profile ukryte za tkaniną" },
      { src: "/images/projects/london-chapel-londyn/06-chapel-feel.jpg", alt: "Antresola kaplicy ze sklepionym sufitem i ścianami w tkaninie — atmosfera wnętrza.", caption: "Atmosfera kaplicy", note: "Tradycyjny charakter zachowany" },
    ],
