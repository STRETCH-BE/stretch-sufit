...
import { blogPosts, findPost, type BlogPost } from "@/content/blog-posts";
...
export async function generateMetadata({
  ...
  const entry = findBlogPost("pl", slug);
...
export default async function BlogPostPage({
  ...
  const dateDisplay = new Date(post.datePublished).toLocaleDateString("pl-PL", {
    year: "numeric",
    month: "long",
    day: "numeric",
  });
    ...
    <>
      ...
      <JsonLd
        data={buildBreadcrumbs([
          ...
          { name: "Blog i FAQ", url: `${BASE_URL}/blog` },
        ...
        <header className="relative isolate overflow-hidden bg-bg pb-16 pt-10 md:pb-24 md:pt-14">
          ...
          <Container>
            <div className="mx-auto max-w-3xl">
              <FadeIn>
                <Eyebrow>
                  {post.category} · {dateDisplay} · {post.readTime} czytania
                </Eyebrow>
              </FadeIn>
              <FadeIn delay={80}>
        ...
        <section className="relative isolate overflow-hidden bg-red py-20 text-white md:py-24">
          ...
          <Container>
            <div className="mx-auto max-w-3xl text-center">
              <Eyebrow tone="on-dark">Od artykułu do pomiaru</Eyebrow>
              <h2 className="mt-6 font-display text-[clamp(1.9rem,4.5vw,3.25rem)] font-semibold leading-[1.05] tracking-[-0.025em] text-white">
                Zobacz materiały na żywo.{" "}
                <span className="it">Bezpłatnie.</span>
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-white/85">
                Doradca przyjedzie z próbnikami, zmierzy pomieszczenia i
                przedstawi wycenę na miejscu. Wycena ważna 30 dni.
              </p>
