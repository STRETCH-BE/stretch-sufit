/**
 * Product landing page — English. /en/solutions/[product]
 * File path: /app/en/solutions/[product]/page.tsx
 */
...
export default async function ProductPageEn({
  ...
  const priceRange = priceRangeFor("en", product.slug);

  const productSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "@id": `${BASE_URL}/en/solutions/${product.slug}#product`,
    name: product.title,
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Solutions", item: `${BASE_URL}/en/solutions` },
      { "@type": "ListItem", position: 3, name: product.label, item: `${BASE_URL}/en/solutions/${product.slug}` },
    ],
  };
    ...
    <>
      ...
      <main>
        ...
        >
          <Container>
            <ol className="flex flex-wrap items-center gap-x-2 gap-y-1 font-mono text-[11px] uppercase tracking-[0.12em] text-white/45">
              ...
              <li><Link href="/en/solutions" className="hover:text-white">Solutions</Link></li>
              <li aria-hidden="true">·</li>
          ...
          <Container>
            <div className="grid gap-12 md:grid-cols-12 md:gap-16">
              <div className="md:col-span-7">
                <FadeIn>
                  <Eyebrow>{product.number} · {product.label}</Eyebrow>
                </FadeIn>
                <FadeIn delay={80}>
        ...
        <section className="text-bg bg-paper py-24 md:py-32">
          <Container>
            <div className="mx-auto max-w-3xl text-center">
              <FadeIn>
                <Eyebrow tone="on-paper">What sets this product apart</Eyebrow>
              </FadeIn>
              <FadeIn delay={80}>
                <SectionTitle className="mt-5 text-bg">
                  Four things{" "}
                  <span className="it">that make the difference.</span>
                </SectionTitle>
              </FadeIn>
            </div>
        ...
        <section className="bg-bg py-24 md:py-32">
          <Container>
            <div className="grid gap-12 md:grid-cols-12 md:gap-16">
              <div className="md:col-span-5">
                <FadeIn>
                  <Eyebrow>Where it excels</Eyebrow>
                </FadeIn>
                <FadeIn delay={80}>
                  <SectionTitle className="mt-5 text-white">
                    Real{" "}
                    <span className="it text-paper">applications.</span>
                  </SectionTitle>
                </FadeIn>
                <FadeIn delay={140}>
                  <p className="mt-6 text-lg leading-relaxed text-white/65">
                    Not every product fits every room. Here's where this one specifically wins.
                  </p>
                </FadeIn>
              </div>
              <div className="md:col-span-7">
        ...
        <section className="text-bg bg-paper py-24 md:py-32">
          <Container>
            <div className="mx-auto max-w-3xl">
              <FadeIn>
                <Eyebrow tone="on-paper">Technical specification</Eyebrow>
              </FadeIn>
              <FadeIn delay={80}>
                <SectionTitle className="mt-5 text-bg">
                  Full spec —{" "}
                  <span className="it">no hidden traps.</span>
                </SectionTitle>
              </FadeIn>
              <FadeIn delay={140}>
          ...
          <Container>
            ...
            <FadeIn delay={80}>
              <h2 className="mt-5 font-display text-2xl font-semibold tracking-[-0.02em] text-bg md:text-3xl">
                Full system —{" "}
                <span className="it">6 Stretch products.</span>
              </h2>
            </FadeIn>
            <FadeIn delay={120}>
        ...
        <section className="relative isolate overflow-hidden bg-red py-24 text-white md:py-28">
          <Container>
            <div className="mx-auto max-w-3xl text-center">
              <Eyebrow tone="on-dark">Book a measurement</Eyebrow>
              <h2 className="mt-6 font-display text-[clamp(2rem,5vw,3.75rem)] font-semibold leading-[1.05] tracking-[-0.025em] text-white">
                {product.label}{" "}
                <span className="it">in your home.</span>
                <br />
                <span className="text-white/85">Free measurement,</span>{" "}
                <span className="it">callback within 24 h.</span>
              </h2>
