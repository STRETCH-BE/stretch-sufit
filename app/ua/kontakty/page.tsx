/**
 * Contact page — Ukrainian. /ua/kontakty
 * File path: /app/ua/kontakty/page.tsx
 */
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/ua/kontakty" },
  openGraph: {
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  "@id": `${BASE_URL}/ua/kontakty#business`,
  name: "Stretch Sufit",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Контакти", item: `${BASE_URL}/ua/kontakty` },
  ],
};
        ...
        <section className="bg-bg py-20 md:py-24">
          <Container>
            <div className="mx-auto max-w-3xl text-center">
              ...
              <FadeIn delay={200}>
                <div className="mt-8">
                  <Link href="/ua/natiazhni-steli" className="inline-flex items-center gap-2 rounded-full border border-white/30 px-6 py-3 font-display text-sm font-semibold text-white transition-colors hover:border-red hover:text-red">
                    Усі міста →
                  </Link>
                </div>
              </FadeIn>
