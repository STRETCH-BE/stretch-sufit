...
export const metadata: Metadata = {
  ...
  description:
    "Натяжні стелі у Польщі. ПВХ виробляється на нашій фабриці в Польщі (безшовно до 6,50 м), поліестер з Бельгії. Частина Stretchgroup. Монтаж за 1 день, без пилу, до 15 років гарантії. Фабрика в Ченстохові (Сілезія), монтаж по всій Польщі.",
  alternates: {
    canonical: "/ua",
