          ...
          <section className="bg-bg py-24 md:py-32">
            <Container>
              <div className="mx-auto max-w-3xl">
                <FadeIn>
                  <Eyebrow>Натяжні стелі {city.locative} — на практиці</Eyebrow>
                </FadeIn>
          ...
          <section className="text-bg bg-paper-2 py-20 md:py-24">
            <Container>
              <div className="grid gap-10 md:grid-cols-12 md:gap-16">
                <div className="md:col-span-5">
                  <FadeIn>
                    <Eyebrow tone="on-paper">Виїзд</Eyebrow>
                  </FadeIn>
                  <FadeIn delay={80}>
                    <h2 className="mt-5 font-display text-2xl font-semibold tracking-[-0.02em] text-bg md:text-3xl">
                      Сусідні міста — <span className="it">також обслуговуємо:</span>
                    </h2>
                  </FadeIn>
                  {city.travel?.noTravelFee && (
                    <FadeIn delay={140}>
                      <p className="mt-6 text-[15px] leading-relaxed text-bg/70">
                        Без окремої плати за виїзд — {city.name} у радіусі 100 км від нашої фабрики в Ченстохові. Замір і розрахунок безкоштовні.
                      </p>
                    </FadeIn>
                  )}
                </div>
