/**
 * Cities hub page — Ukrainian. /ua/natiazhni-steli
 * File path: /app/ua/natiazhni-steli/page.tsx
 */
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/ua/natiazhni-steli" },
  openGraph: {
