 ...
 * working in Poland — currently installers only (surveyor / advisor /
 * production roles removed 2026-08 — re-add to `roles` when they
 * reopen). Slug "kariera" coincides with PL spelling.
 */
...
export const metadata: Metadata = {
  ...
  description:
    "Працюйте у Stretch Sufit — частина бельгійської Stretchgroup. Монтажник натяжних стель. Трудовий договір, службовий автомобіль, навчання в Бельгії. Ченстохова і вся Польща.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Відкриті вакансії у Stretch Sufit — монтажники натяжних стель. Трудовий договір, авто, навчання.",
    type: "website",
...
const benefits = [
  ...
  },
  {
    ...
    body: "Стабільна основа відповідно до ролі + система премій залежно від позиції. Монтажник — премії за реалізованими проєктами.",
  },
  {
    label: "Обладнання",
...
const values = [
  ...
  {
    no: "Вчимо.",
    yes: "Новий монтажник проводить перші 2 тижні на об'єкті із сеньйором. Інвестуємо в це.",
  },
];
