/**
 * City page — Ukrainian. /uk/natiazhni-steli/[misto]
 * File path: /app/uk/natiazhni-steli/[misto]/page.tsx
 *
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/uk/natiazhni-steli/${city.slug}` },
    openGraph: {
...
export default async function CityPageUk({
  ...
  const breadcrumbSchema = buildBreadcrumbs([
    { name: "Головна", url: `${BASE_URL}/uk` },
    { name: "Натяжні стелі", url: `${BASE_URL}/uk/natiazhni-steli` },
        ...
        <nav aria-label="breadcrumb" className="border-b border-white/5 bg-bg pb-4 pt-28 md:pt-32">
          <Container>
            <ol className="flex flex-wrap items-center gap-x-2 gap-y-1 font-mono text-[11px] uppercase tracking-[0.12em] text-white/45">
              ...
              <li><Link href="/uk/natiazhni-steli" className="hover:text-white">Натяжні стелі</Link></li>
              <li aria-hidden="true">·</li>
