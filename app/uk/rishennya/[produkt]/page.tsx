/**
 * Product landing page — Ukrainian. /uk/rishennya/[produkt]
 * File path: /app/uk/rishennya/[produkt]/page.tsx
 */
...
export async function generateMetadata({
  ...
  return {
    title,
    description,
    alternates: { canonical: `/uk/rishennya/${product.slug}` },
    openGraph: {
      title,
      description,
      type: "website",
      url: `${BASE_URL}/uk/rishennya/${product.slug}`,
      locale: "uk_UA",
    },
  };
}
...
export default async function ProductPageUk({
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "@id": `${BASE_URL}/uk/rishennya/${product.slug}#product`,
    name: product.title,
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Рішення", item: `${BASE_URL}/uk/rishennya` },
      { "@type": "ListItem", position: 3, name: product.label, item: `${BASE_URL}/uk/rishennya/${product.slug}` },
    ],
  };
        ...
        <nav aria-label="breadcrumb" className="border-b border-white/5 bg-bg pb-4 pt-28 md:pt-32">
          <Container>
            <ol className="flex flex-wrap items-center gap-x-2 gap-y-1 font-mono text-[11px] uppercase tracking-[0.12em] text-white/45">
              ...
              <li><Link href="/uk/rishennya" className="hover:text-white">Рішення</Link></li>
              <li aria-hidden="true">·</li>
              ...
              <div className="md:col-span-7">
                ...
                <FadeIn delay={260}>
                  <div className="mt-10 flex flex-wrap items-center gap-4">
                    <Link href="/uk#cta" className="inline-flex items-center gap-2 rounded-full bg-red px-7 py-4 font-display text-base font-semibold text-white transition-transform hover:scale-[1.02]">
                      Безкоштовний замір →
                    </Link>
