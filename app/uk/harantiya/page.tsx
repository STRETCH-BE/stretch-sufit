/**
 * Warranty page — Ukrainian. /uk/harantiya
 * File path: /app/uk/harantiya/page.tsx
 */
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/uk/harantiya" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Гарантія", item: `${BASE_URL}/uk/harantiya` },
  ],
};
