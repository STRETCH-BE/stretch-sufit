/**
 * FAQ page — Ukrainian. /uk/pytannya
 * File path: /app/uk/pytannya/page.tsx
 */
...
import { faqs, faqCategoriesUk } from "@/content/uk/faq";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/uk/pytannya" },
  openGraph: {
