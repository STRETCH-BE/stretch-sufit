    ...
    <section className="bg-bg text-white">
      <Container className="grid gap-10 py-20 md:grid-cols-12 md:gap-14 md:py-28">
        ...
        <div className="md:col-span-7">
          <ul className="space-y-5 text-base leading-relaxed text-white md:text-lg">
            {bullets.map((b, i) => (
              <li key={i} className="flex gap-4">
                ...
                <span>
                  ...
                  <span className="text-white">— {b.body}</span>
                </span>
              </li>
            ))}
          </ul>
          <p className="mt-10 border-l-2 border-red pl-5 text-sm italic leading-relaxed text-white md:text-base">
            {caption}
          </p>
        </div>
      </Container>
