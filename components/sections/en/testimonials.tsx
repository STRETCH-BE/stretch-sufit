 ...
 * File path: /components/sections/en/testimonials.tsx
 */
        ...
        <div className="mb-16 flex flex-col items-start justify-between gap-8 md:flex-row md:items-end md:gap-16">
          <FadeIn>
            ...
            <SectionTitle className="mt-5 text-white">
              5.0 <span className="it">on Google.</span>
            </SectionTitle>
          </FadeIn>
          <FadeIn delay={120}>
            <p className="max-w-md text-[16px] leading-[1.6] text-white/55">
              Over 230 reviews on Google Maps and Opineo. Average 4.96 / 5. The most repeated word: "professional".
            </p>
          </FadeIn>
        </div>
